...
const dropdownTemplate0 = (rowData, { rowIndex }) => <p >{rowData.OrganizationName?.OrganizationName}</p>
const dropdownArrayTemplate1 = (rowData, { rowIndex }) => <p >{rowData.OrganizationType}</p>
...
<Column field="OrganizationName" header="Organization Name" body={dropdownTemplate0} filter={selectedFilterFields.includes("OrganizationName")} hidden={selectedHideFields?.includes("OrganizationName")}  style={{ minWidth: "8rem" }} />
<Column field="OrganizationType" header="Organization Type" body={dropdownArrayTemplate1} filter={selectedFilterFields.includes("OrganizationType")} hidden={selectedHideFields?.includes("OrganizationType")}  style={{ minWidth: "8rem" }} />
<Column field="OwnershipType" header="OwnershipType" body={pTemplate2} filter={selectedFilterFields.includes("OwnershipType")} hidden={selectedHideFields?.includes("OwnershipType")}  sortable style={{ minWidth: "8rem" }} />
