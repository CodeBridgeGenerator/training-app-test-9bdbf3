        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">BusinessInformation</h3>
                </div>
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">OrganizationName</label><p className="m-0 ml-3" >{_entity?.OrganizationName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">FullTimeEployees</label><p className="m-0 ml-3" >{Number(_entity?.FullTimeEployees)}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">PartTimeEmployees</label><p className="m-0 ml-3" >{Number(_entity?.PartTimeEmployees)}</p></div>
